...
#else
static const char *fonts[]               = { "Font Awesome 5 Free:pixelsize=12", "Roboto:style=Bold:pixelsize=12:antialias=true:autohint=true"  };
...
static const Rule rules[] = {
	...
	RULE(.class = "love", .isfloating = 1)
	RULE(.class = "Gimp", .tags = 1 << 7, .monitor = 0)
	RULE(.class = "Rawtherapee", .tags = 1 << 7, .monitor = 1)
	RULE(.class = "Firefox", .tags = 1 << 2)
	RULE(.class = "Brave-browser", .tags = 1 << 2)
	RULE(.class = "PyRadio", .tags = 1 << 8, .monitor = 0)
	RULE(.class = "Code", .tags = 1 << 1)
	RULE(.class = "whatsapp", .tags = 1 << 3, .monitor = 0)
	RULE(.class = "Transmission", .tags = 1 << 8, .monitor = 0)
	RULE(.class = "discord", .tags = 1 << 3, .monitor = 0)
	RULE(.class = "steam", .tags = 1 << 4, .monitor = 0)
	RULE(.class = "Mailspring", .tags = 1 << 3, .monitor = 0)
	RULE(.class = "fluent-reader", .tags = 1 << 4, .monitor = 0)
	#if SCRATCHPADS_PATCH
