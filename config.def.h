...
#else
static const char *fonts[]               = { "Alt_FontAwesome_ACM:pixelsize=12", "Roboto:style=Bold:pixelsize=12:antialias=true:autohint=true"  };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "Roboto:style=Bold:pixelsize=12:antialias=true:autohint=true";

static char c000000[]                    = "#000000"; // placeholder value


static char normfgcolor[]                = "#f0f5f5";
static char normbgcolor[]                = "#3d3d5c";
static char normbordercolor[]            = "#000000";
static char normfloatcolor[]             = "#f0f5f5";

static char selfgcolor[]                 = "#76b1c2";
static char selbgcolor[]                 = "#3d3d5c";
static char selbordercolor[]             = "#76b1c2";
static char selfloatcolor[]              = "#005577";

static char titlenormfgcolor[]           = "#76b1c2";
static char titlenormbgcolor[]           = "#3d3d5c";
static char titlenormbordercolor[]       = "#444444";
static char titlenormfloatcolor[]        = "#db8fd9";

static char titleselfgcolor[]            = "#76b1c2";
static char titleselbgcolor[]            = "#3d3d5c";
static char titleselbordercolor[]        = "#005577";
static char titleselfloatcolor[]         = "#005577";

static char tagsnormfgcolor[]            = "#bbbbbb";
static char tagsnormbgcolor[]            = "#3d3d5c";
...
static char hidnormbgcolor[]             = "#3d3d5c";
static char hidselbgcolor[]              = "#3d3d5c";

static char urgfgcolor[]                 = "#bbbbbb";
static char urgbgcolor[]                 = "#3d3d5c";
...
const char *spcmd1[] = {"alacritty", "-t", "quickTerminal", "-g", "120x34", NULL };
...
static const Rule rules[] = {
	...
	RULE(.class = "love", .monitor = 0, .isfloating = 1)	
	RULE(.class = "steam", .tags = 1 << 0, .monitor = 0)
	RULE(.class = "Code", .tags = 1 << 1)
	RULE(.class = "Firefox", .tags = 1 << 2)
	RULE(.class = "Brave-browser", .tags = 1 << 2)
	RULE(.class = "whatsapp", .tags = 1 << 3, .monitor = 0)
	RULE(.class = "discord", .tags = 1 << 3, .monitor = 0)
	RULE(.class = "Mailspring", .tags = 1 << 3, .monitor = 0)
	RULE(.class = "Gimp", .tags = 1 << 4, .monitor = 0)
	RULE(.class = "Rawtherapee", .tags = 1 << 4, .monitor = 0)
	RULE(.class = "Audacity", .tags = 1 << 5, .monitor = 0)
	RULE(.class = "kdenlive", .tags = 1 << 6, .monitor = 0)
	RULE(.class = "fluent-reader", .tags = 1 << 7, .monitor = 0)
	#if RENAMED_SCRATCHPADS_PATCH
	RULE(.instance = "spterm", .scratchkey = 's', .isfloating = 1)
	#elif SCRATCHPADS_PATCH
	RULE(.title = "cmus", .tags = SPTAG(0), .isfloating = 1)
	RULE(.title = "Calendar", .tags = SPTAG(0), .isfloating = 1)
	RULE(.title = "Calculator", .tags = SPTAG(0), .isfloating = 1)
	RULE(.title = "privateinternetaccess", .tags = SPTAG(0), .isfloating = 1)
	RULE(.class = "Pavucontrol", .tags = SPTAG(0), .isfloating = 1) // pavucontrol
	RULE(.title = "PyRadio", .tags = SPTAG(0), .isfloating = 1)
	RULE(.class = "Transmission", .tags = SPTAG(0), .isfloating = 1)
	#endif // SCRATCHPADS_PATCH
};
...
static const Key keys[] = {
	...
	#if SHIFTVIEW_PATCH
	{ MODKEY|Mod1Mask,             XK_Tab,        shiftview,              { .i = -1 } },
	{ MODKEY|Mod1Mask,             XK_backslash,  shiftview,              { .i = +1 } },
